# Generated by Django 3.1.2 on 2020-12-24 12:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(default='ussd', max_length=50)),
                ('created_at', models.DateTimeField(help_text='Created datetime received from Flutterwave')),
                ('account_id', models.PositiveIntegerField()),
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flw_transactions', to='flutterwave.flwplanmodel')),
